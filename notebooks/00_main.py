...
with_user_agent_extra("transpiler_target_tech", target_type)
if target_type == TargetType.SDP.value:
    with_user_agent_extra("transpiler_sdp_language", switch_config.sdp_language)
ws.current_user.me().user_name  # Trigger user fetch for logging
...
if params.target_type in [TargetType.NOTEBOOK.value, TargetType.SDP.value]:
    ...
    orchestrator_result = dbutils.notebook.run(
        ...
        0,
        {
            ...
            "request_params": params.request_params or "",
    ...
    orchestrator_result = dbutils.notebook.run(
        ...
        0,
        {
            ...
            "log_level": params.log_level,
            "output_dir": params.output_dir,
            "output_extension": params.output_extension or "",
        },
    )
